...
export default class CreateStory extends Component {
  ...
  render() {
    if (!this.state.fontsLoaded) {
      ...
      let preview_images = {
        image_1: require("../assets/casa01.png"),
        image_2: require("../assets/casa02.png"),
        image_3: require("../assets/casa03.png"),
        image_4: require("../assets/casa04.png"),
        ...
        >
          ...
          <View style={styles.appTitle}>
            <View style={styles.appIcon}>
              <Image
                source={require("../assets/casa01.png")}
